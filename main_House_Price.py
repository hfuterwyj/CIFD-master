...
if __name__ == '__main__':
    ...
    rmse_list = []
    for k_index in range(10, 11):
        train_data_file = "house_price_e1.csv"
        train_data = pd.read_csv("dataset/house_price_data/" + train_data_file, delimiter=",")
        ...
        np.save("Result/ce_result/ce_house_price_e1_pcd_dmb_a=0.01.npy", ce_result)
        ...
        # testing process
        filename = "house_price_e1.csv"
        test_data = pd.read_csv("dataset/house_price_data/" + filename, delimiter=",")
    ...
    print("The rmse list为：", rmse_list)
    print("The best rmse为：", min(rmse_list))
